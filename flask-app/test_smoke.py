...
class TestSmoke(unittest.TestCase):
    ...
    # TODONOW now passes as expected because issue fixed. Remove this test later,
    # should keep smoke tests minimal because take a lot of time because they do real API requests
