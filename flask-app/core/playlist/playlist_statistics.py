...
class PlaylistStatistics:
    ...
    def get_average_release_year_string(self):
        return Utils.convert_number_to_string(self.average_release_year)

    def get_average_popularity_string(self):
        return Utils.convert_number_to_string(self.average_popularity)

    def get_average_tempo_string(self):
        return Utils.convert_number_to_string(self.average_tempo)

    def get_average_danceability_string(self):
        return Utils.convert_number_to_string(self.average_danceability)

    def get_average_energy_string(self):
        return Utils.convert_number_to_string(self.average_energy)

    def get_average_valence_string(self):
        return Utils.convert_number_to_string(self.average_valence)

    def get_average_instrumentalness_string(self):
        return Utils.convert_number_to_string(self.average_instrumentalness)

    def get_average_acousticness_string(self):
        return Utils.convert_number_to_string(self.average_acousticness)

    def get_average_liveness_string(self):
        return Utils.convert_number_to_string(self.average_liveness)

    def get_average_speechiness_string(self):
        return Utils.convert_number_to_string(self.average_speechiness)
