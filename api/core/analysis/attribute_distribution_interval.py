class AttributeDistributionInterval:
    ...
    def __is_value_in_interval(self, value):
        if self.min_value is None and self.max_value_exclusive is None:
            return True
        if self.min_value is None:
            return value < self.max_value_exclusive
        if self.max_value_exclusive is None:
            return value >= self.min_value

        return self.min_value <= value < self.max_value_exclusive
