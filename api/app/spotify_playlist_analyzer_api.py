...
def __extract_filter_params_from_request_params(request_params):
    ...
    if filter_by == "artists":
        return __extract_filter_params_from_request_params_for_artists(request_params)

    if filter_by == "title":
        return __extract_filter_params_from_request_params_for_title(request_params)

    if filter_by == "genres":
        return __extract_filter_params_from_request_params_for_genres(request_params)

    if filter_by == "key":
        return __extract_filter_params_from_request_params_for_key(request_params)

    if filter_by == "mode":
        return __extract_filter_params_from_request_params_for_mode(request_params)

    if filter_by == "key_signature":
        return __extract_filter_params_from_request_params_for_key_signature(request_params)

    if filter_by == "release_year":
        return __extract_filter_params_from_request_params_for_release_year(request_params)

    if filter_by == "tempo":
        return __extract_filter_params_from_request_params_for_tempo(request_params)
